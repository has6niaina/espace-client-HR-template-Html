...
var dzsap_list = [], dzsap_yt_list = [], dzsap_ytapiloaded = !1, dzsap_globalidind = 20,
    dzsap_list_for_sync_sw_built = !1, dzsap_list_for_sync_inter_build = 0;
        ...
        c.fn.audioplayer = function (a) {
            ...
            this.each(function () {
                ...
                function k() {
                    ...
                    c.ajax({
                        type: "GET", url: d, crossDomain: !0, success: function (a) {
                ...
                function u() {
                    ...
                    "0" != b.attr("data-playfrom") || (B = pb = 0, c(m) && c(m).html() && -1 < c(m).html().indexOf("api.soundcloud.com") && 0 != m.currentTime && oa(0, {call_from: "first_played_false"}));
                ...
                function l(a) {
                    ...
                    if ("click" ==
                        a.type && (b.hasClass("comments-btn-cancel") && (d.removeClass("active"), d.find("input").val("")), b.hasClass("comments-btn-submit"))) return a = "", d.find(".comment_email").length && (a = d.find(".comment_email").eq(0).val()), gc(d.find(".comment_text").eq(0).val(), a), d.removeClass("active"), d.find("input").val(""), !1
                }
                ...
                function fb(a) {
                    if ("undefined" != typeof window.getSelection && "undefined" != typeof document.createRange) {
                        ...
                        a.removeAllRanges();
                        a.addRange(b)
                    } else "undefined" != typeof document.selection && "undefined" !=
                ...
                function Cb(a, b) {
                    ...
                    g && g.api_draw_curr_time && (g.api_set_time_curr(H), g.api_get_times({call_from: " change visual target .. in api "}),
                        g.api_check_time({fire_only_once: !0}), g.api_draw_curr_time(), g.api_draw_scrub_prog());
                    setTimeout(function () {
                ...
                function Db(d) {
                    ...
                    "canvas" == a.skinwave_wave_mode && (Ha(Za.get(0), b.attr("data-pcm"), "#" + a.design_wave_color_bg, {call_from: "canvas_change_pcm_bg"}), Ha($a.get(0), b.attr("data-pcm"), "#" + a.design_wave_color_progress, {call_from: "canvas_change_pcm_prog"}))
                }
                ...
                function hc(d, g) {
                    ...
                    ab = !1;
                    "skin-wave" == a.design_skin && ("canvas" == a.skinwave_wave_mode && (bb = q ? d.attr("data-source") : d, d && h.pcm ? (b.attr("data-pcm", d.attr("data-pcm")), ka(d.attr("data-pcm"))) : ua({call_from: "regenerate_canvas_from_change_media"}),
                        "" != h.pcm ? (ka(h.pcm), b.attr("data-pcm", h.pcm)) : (w.addClass("fast-animate-scrubbar"), b.removeClass("scrubbar-loaded"), setTimeout(function () {
                    ...
                    "soundcloud" == g && -1 == h.source.indexOf("api.soundcloud") ? (xa = h.source, console.log("RETRIEVE SOUNDCLOUD URL"), rb = !0, setTimeout(function () {
                        rb = !0
                    }, 501), Fb()) : Da({call_from: "change_media"});
                    W();
                ...
                function Gc(d) {
                    var g = c(this), h = parseInt(d.clientX, 10) - g.offset().left;
                    qb =
                        h / g.width() * 100 + "%";
                    htmlEncode("");
                ...
                function gc(d, g, h) {
                    if (g) {
                        if (0 == /^(([^<>()[\]\\.,;:\s@"]+(\.[^<>()[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/.test(g)) return alert("please insert email, your email is just used for gravatar. it will not be sent or stored anywhere"), !1;
                        h = String(g).split("@")[0];
                ...
                function Sa(a) {
                    ...
                    if (1 != ab) return a || (a = Mb), console.log(a, c(a)), m = new YT.Player(a + "", {
                        height: "200",
                        width: "200",
                ...
                function Nb(a) {
                    ...
                    m &&
                    m.getPlayerState ? (Ea({call_from: "check_yt_ready_phase_two"}), Jc && setTimeout(function () {
                ...
                function Eb(d) {
                    ...
                    b.attr("data-pcm") || (d = {
                        ...
                        postdata: "1", source: b.attr("data-source"), playerid: za
                    }, a.settings_php_handler && (c.ajax({
                        type: "POST", url: a.settings_php_handler, data: d, success: function (d) {
                            if (d) "0" != d && -1 < d.indexOf(",") ? (b.attr("data-pcm", d), cb = !0, w.css("opacity"), setTimeout(function () {
                                b.addClass("scrubbar-loaded");
                                Bb();
                                setTimeout(function () {
                                }, 100)
                            }, 100)) : (Ob = !0, ua({call_from: "no response from pcm ajax, generate it"})); else if ("on" == a.cue) Ob = !0, ua({call_from: "pcm_data_try_to_generate .. no data-pcm"}); else if (hd = !0, "on" == a.pcm_data_try_to_generate_wait_for_real_pcm) {
                                d =
                                    [];
                ...
                function ua(d) {
                    ...
                    if (!Ob) return setTimeout(function () {
                        g.call_attempt++;
                        10 > g.call_attempt && ua(g)
                    }, 1E3), !1;
                    if (window.WaveSurfer) t({call_from: "wavesurfer already loaded"}); else {
                        ...
                        6 > dzsap_wavesurfer_load_attempt && c.ajax({
                            url: f, dataType: "script", success: function (a) {
                ...
                function ka(d) {
                    ...
                    w.find(".scrub-bg-img.transitioning-in,.scrub-prog-img.transitioning-in").animate({opacity: 1},
                        {
                ...
                function Fb(d) {
                    ...
                    var g = a.php_retriever + "?scurl=" +
                        d;
                    c.ajax({
                        type: "GET", url: g, data: {}, async: !0, dataType: "text", error: function (a, b, d) {
                ...
                function ba(a, b) {
                    ...
                    b && c.extend(d, b);
                    ea && (b = ea.find(".dzstooltip--inner"), b = b.children().eq(a), d = b.attr("data-playerid"), b = c('.audioplayer[data-playerid="' + d + '"],.audioplayer-tobe[data-playerid="' + d + '"]'), d && b.length && b.eq(0).get(0) && b.eq(0).get(0).api_play_media ? c('.audioplayer[data-playerid="' + d + '"]').eq(0).get(0).api_play_media({call_from: "api_sync_players_prev"}) :
                ...
                function Ia(a) {
                    ...
                    if (ea) {
                        ...
                        var h = "", e;
                        for (e in dzsap_list_for_sync_players) a =
                        ...
                        c(document).on("mousemove.dzsap_playlist_item", function (a) {
                            if (window.dzsap_moving_playlist_item) {
                                ...
                                dzsap_playlist_item_target.parent().children(':not(".target-playlist-item"):not(".cloner")').each(function () {
                                    var a = c(this), d = a.offset().top - dzsap_playlist_con.offset().top;
                ...
                function S(d) {
                    var g =
                        {setup_inner_player: !0, setup_media: !0, setup_otherstructure: !0, call_from: "default"};
                    d && (g = c.extend(g, d));
                    ...
                    if ("skin-default" == a.design_skin || "skin-wave" == a.design_skin) h += '<div class="ap-controls-right">', "on" != a.disable_volume && (h += '<div class="controls-volume"><div class="volumeicon"></div><div class="volume_static"></div><div class="volume_active"></div><div class="volume_cut"></div></div>'), h += "</div>";
                    h += "</div>";
                    if ("skin-wave" == a.design_skin && "small" == L) h = '<div class="the-bg"></div><div class="ap-controls-left">' + f + "</div>" + d + '<div class="ap-controls-right">' + k + '<div class="extrahtml-in-float-right for-skin-wave-small">' +
                ...
                function da() {
                    if ("on" != a.skinwave_enableSpectrum) if ("canvas" == a.skinwave_wave_mode) b.attr("data-pcm") ? (cb = !0, R()) : Q(); else {
                ...
                function Ha(b, g, h, e) {
                    ...
                    if (!g) return setTimeout(function () {
                        ...
                        1E3), !1;
                    if ("object" == typeof g) k = g; else try {
                        k = JSON.parse(g)
                    } catch (Ud) {
                    }
                    var m = g = 0;
                    ...
                    if (0 < u) for (g = 0; g < m; g++) wb = !0, p = Math.ceil(k.length / m * g), l = Math.abs(k[p] * b * u), e.beginPath(), e.rect(g * q, b * r, q - n, l), "spectrum" == d.call_from && (W = g / m < H / B ? !0 : !1), W ? ("reflecto" != a.skinwave_wave_mode_canvas_mode && (e.fillStyle = f(La, .25)), v.length && (p = e.createLinearGradient(0, 0, 0, b), l = f("#" + v[1], .25),
                ...
                function nc(d) {
                    ...
                    a.settings_php_handler && c.ajax({
                        type: "POST", url: a.settings_php_handler, data: d, success: function (a) {
                            var d = !1;
                ...
                function oc(d) {
                    d =
                        {action: "dzsap_get_views", postdata: d, playerid: D};
                ...
                function wa(b) {
                    b =
                        {action: "dzsap_submit_download", postdata: b, playerid: D};
                ...
                function Kb(d) {
                    ...
                    a.settings_php_handler && c.ajax({
                        type: "POST", url: a.settings_php_handler, data: g, success: function (d) {
                    ...
                    if (1 != ab && "youtube" != b.attr("data-original-type")) {
                        ...
                        if ("audio" == y || "normal" == y || "soundcloud" == y) d = d + '<audio preload="' + (a.preload_method + '"'), "on" == a.skinwave_enableSpectrum && (d += ' crossOrigin="anonymous"'), is_ios() && "change_media" == g.call_from && (e += " autoplay"), d += ">", h = "", b.attr("data-source") && ("icecast" != na && (xa = b.attr("data-source")), "fake" != xa ? (h += '<source src="' + xa + '" type="audio/mpeg">', void 0 != b.attr("data-sourceogg") && (h += '<source src="' +
                            ...
                            console.log("errored out", this, this.audioElement, this.duration,
                                d, d.target.error);
                            if (this.networkState === HTMLMediaElement.NETWORK_NO_SOURCE && 0 == dzsap_is_mobile() && 0 == b.hasClass("errored-out")) if (console.log("%c could not load audio source - ", "color:#ff2222;", b.attr("data-source")), 5 > ld) setTimeout(function (a) {
                                m && (m.src = "");
                                setTimeout(function () {
                                    m && (m.src = b.attr("data-source"), m.load())
                                }, 1E3)
                            }, 1E3, d), ld++; else if ("on" == a.notice_no_media) {
                ...
                function Ea(d) {
                    ...
                    if (!b.hasClass("dzsap-loaded")) {
                        var g =
                            {do_not_autoplay: !1, call_from: "init"};
                        d && (g = c.extend(g, d));
                        setTimeout(function () {
                            od = !0
                        }, 5E3);
                ...
                function Xc(a) {
                    ...
                    if (0 != b.has(d).length) {
                        ...
                        "mousemove" == a.type && (h = a.pageX - d.offset().left,
                            d.offset(), Va = Math.round(h / (d.outerWidth() / 5)), Va = 4 < Va ? 5 : Math.round(Va), 1 > Va && (Va = 1), b.find(".rating-prog").css({width: Va / 5 * 100 + "%"}), Ga = -1, b.find(".star-rating-set-clip").css({opacity: 0}));
                ...
                function Yc() {
                    if ("skin-wave" == a.design_skin) {
                        if ("on" == a.skinwave_enableSpectrum) {
                            ...
                            if ($c) {
                                if (0 == M[0] && 0 == M[Math.round(M.length / 4)] && 0 == M[Math.round(M.length / 2)] && 0 == M[Math.round(M.length / 3 / 4)]) "auto" == Zb && (Zb = "on", sd = "lastarray0"); else if ("auto" == Zb || "lastarray0" == sd) Zb = "off";
                                $c = !1
                            }
                            if (M && M.length) {
                ...
                function sa(d) {
                    ...
                    Z &&
                    (ha < Z && (ha = Z), Xa && H > Xa && (d = {call_from: "time_curr>pseudo_sample_time_end"}, sc(d), kb = !0, clearTimeout(ac), ac = setTimeout(function () {
                        kb = !1
                    }, 1E3)));
                    ...
                    if ("skin-minimal" == a.design_skin) if (yd) if (ta || 0 == Nc) {
                        if (Fa) {
                            d = Fa.getContext("2d");
                            var e = Fa.width, f = Fa.height, k = e / 100, l = f / 100;
                            K = H / B * Math.PI * 2;
                            isNaN(K) && (K = 0);
                    ...
                    } else return 1 != g.fire_only_once && requestAnimFrame(sa),
                        !1; else P.addClass("canvas-fallback");
                    Yc();
                    od && 1 < B && H >= B - .07 && (d = {call_from: "time_total > 0 && time_curr >= time_total - 0.07 ... "}, a.fakeplayer || (sc(d), kb = !0, clearTimeout(ac), ac = setTimeout(function () {
                        kb = !1
                    }, 1E3)));
                ...
                function rd() {
                    if (a.fakeplayer) return a.fakeplayer.get(0).api_sync_players_goto_prev(),
                        !1;
                    if (ea && ea.children(".dzstooltip--inner").length) {
                        var d = ic - 1;
                        0 <= d && ba(d, {call_from: "api_sync_players_prev"})
                    } else if (0 < dzsap_list_for_sync_players.length) for (d in dzsap_list_for_sync_players) {
                        var c = b;
                        q && (c = q);
                ...
                function Wc() {
                    if (a.fakeplayer) return a.fakeplayer.get(0).api_sync_players_goto_next(),
                        !1;
                    if (ea && ea.find(".playlist-menu-item").length) {
                        var d = ic + 1;
                        d - 1 > ea.find(".playlist-menu-item").length || ba(d, {call_from: "api_sync_players_prev"})
                    } else if (d = null, 0 < dzsap_list_for_sync_players.length) for (var c in dzsap_list_for_sync_players) if (d = b, q && (d = q), dzsap_list_for_sync_players[c].get(0) == d.get(0) && (c = parseInt(c, 10), d = c + 1, d < dzsap_list_for_sync_players.length)) {
                ...
                function sc(d) {
                    ...
                    setTimeout(function () {
                        if (q && (q.hasClass("is-single-player") ||
                            q.hasClass("feeded-whole-playlist"))) return q.get(0).api_handle_end({call_from: "handle_end fake_player"}), !1;
                        xc && xc(b, {})
                    }, 200)
                }
                ...
                function Pa(d, g) {
                    ...
                    "skin-wave" == a.design_skin && (G = w.outerWidth(!1), w.outerHeight(!1), C && (g = 0, w && b && w.offset() ? g = w.offset().left -
                        b.offset().left : console.log("no scrubbar or cthis", w, b), C.css({width: G}), b.hasClass("skin-wave-mode-small") && C.css({left: g + "px"}), C.addClass("active")));
                    ...
                    "none" != b.css("display") && (w.find(".scrub-bg-img").eq(0).css({}),
                        w.find(".scrub-prog-img").eq(0).css({width: w.children(".scrub-bg").width()}), w.find(".scrub-prog-canvas").eq(0).css({width: w.children(".scrub-bg").width()}), w.find(".scrub-prog-img-reflect").eq(0).css({width: w.children(".scrub-bg").width()}), w.find(".scrub-prog-canvas-reflect").eq(0).css({width: w.children(".scrub-bg").width()}));
                    ...
                    "skin-minion" == a.design_skin && (g = parseInt(Ka.find(".con-playpause").eq(0).offset().left, 10) - parseInt(Ka.eq(0).offset().left,
                        ...
                        top: 0,
                        left: g
                    }), g += 36, Ka.find(".next-btn").eq(0).css({top: 0, left: g}));
                    "on" == a.embedded && window.frameElement && (g = {height: b.outerHeight()}, a.embedded_iframe_id && (g.embedded_iframe_id = a.embedded_iframe_id), window.parent.postMessage({
                        name: "resizeIframe",
                        params: g
                    }, "*"));
                    $b();
                ...
                function Ad() {
                    ...
                    a.restyle_player_under_400 && (yb ? (console.log("RESTYLING WITH CLASS -> ", a.restyle_player_under_400), b.removeClass(a.restyle_player_over_400), b.addClass(a.restyle_player_under_400)) : (console.log("RESTYLING WITH CLASS -> ", a.restyle_player_over_400), b.removeClass(a.restyle_player_under_400), b.addClass(a.restyle_player_over_400)), r(), tb(), O.append(b.find(".meta-artist-con")), b.find(".ap-controls").remove(), O.children(".the-thumb-con").remove(), yb ? (console.log("RESTYLING WITH CLASS -> ", a.restyle_player_under_400),
                        b.removeClass(a.restyle_player_over_400), b.addClass(a.restyle_player_under_400)) : (b.css({"padding-top": ""}), console.log("RESTYLING WITH CLASS -> ", a.restyle_player_over_400), b.removeClass(a.restyle_player_under_400), b.addClass(a.restyle_player_over_400)), S({
                ...
                function rc(d) {
                    var g = c(this);
                    "mousemove" == d.type && cd && (e = (d.pageX - J.find(".volume_static").eq(0).offset().left) / J.find(".volume_static").eq(0).width(), g.parent().hasClass("volume-holder") || g.hasClass("volume-holder"), "skin-redlights" == a.design_skin && (e *= 10, e = Math.round(e), e /= 10), db(e, {call_from: "set_by_mousemove"}), zb = !1);
                    ...
                    (e = 1 - (d.pageY - J.find(".volume_static").eq(0).offset().top) / J.find(".volume_static").eq(0).height()), g.hasClass("volume-holder") && (e = 1 - (d.pageY - J.find(".volume_static").eq(0).offset().top) / J.find(".volume_static").eq(0).height(), console.log(e)), db(e, {call_from: "set_by_mouseclick"}), zb = !1);
                    "mousedown" == d.type && (cd = !0, b.addClass("volume-dragging"), e = (d.pageX - J.find(".volume_static").eq(0).offset().left) / J.find(".volume_static").eq(0).width(), g.parent().hasClass("volume-holder") && (e = 1 - (d.pageY - J.find(".volume_static").eq(0).offset().top) /
                        J.find(".volume_static").eq(0).height()), db(e, {call_from: "set_by_mousedown"}), zb = !1);
                ...
                function Sc(d) {
                    ...
                    }, 50), oa(h, {call_from: "handle_mouse_scrubbar"}), "on" == a.autoplay_on_scrub_click && 0 == ta &&
                    Y({call_from: "handle_mouse_scrubbar"}), b.hasClass("from-wc_loop"))) return !1
                }
                ...
                function oa(d, g) {
                    ...
                    d = xd(d);
                    Z && (d < Z && (d = Z), d > Xa && (d = Xa));
                    if (a.fakeplayer) return g = {
                        type: cc,
                        fakeplayer_is_feeder: "on"
                    }, a.fakeplayer.length && a.fakeplayer.data("feeding-from") !=
                    b.get(0) && ("handle_end" != h.call_from && "from_playfrom" != h.call_from && "last_pos" != h.call_from ? (g.call_from = "seek_to from player source->" + b.attr("data-source") + " < -  old call from - " + h.call_from, a.fakeplayer.get(0).api_change_media(b, g)) : (Wa = ha = H = d, b.data("promise-to-play-footer-player-from", d))), setTimeout(function () {
                    ...
                    if ("audio" == y) {
                        if (m && "undefined" != typeof m.currentTime) try {
                            m.currentTime = d
                        } catch (Oa) {
                ...
                function Cd(d, c) {
                    J.hasClass("controls-volume-vertical") ? J.find(".volume_active").eq(0).css({
                        ...
                        d
                    }) : J.find(".volume_active").eq(0).css({width: J.find(".volume_static").eq(0).width() * d});
                    "skin-wave" == a.design_skin && "on" == a.skinwave_dynamicwaves && (w.find(".scrub-bg-img").eq(0).css({transform: "scaleY(" + d + ")"}), w.find(".scrub-prog-img").eq(0).css({transform: "scaleY(" + d + ")"}), "on" == a.skinwave_enableReflect && (0 == d ? b.find(".scrub-bg-img-reflect").fadeOut("slow") : b.find(".scrub-bg-img-reflect").fadeIn("slow")));
                ...
                function Md(a) {
                    0 ==
                    zb ? (Dd = Gb, db(0, {call_from: "from_mute"}), zb = !0) : (db(Dd, {call_from: "from_unmute"}), zb = !1)
                }
                ...
                function Qa(d) {
                    ...
                    1 != g.donot_change_media && null != a.fakeplayer ? (d = {
                        ...
                        100)) : ("youtube" == y && m && m.pauseVideo && m.pauseVideo(), "audio" == y && (m && ("stop" == a.pause_method ? (m.pause(), m.src = "", La(), c(m).remove(), m = null) : m.pause && m.pause()), la && la.pause && la.pause()), q && q.get(0).api_pause_media_visual({call_from: "pause_media in child player"}));
                    ta = !1;
                    b.removeClass("is-playing");
                    b.parent().hasClass("zoomsounds-wrapper-bg-center") && b.parent().removeClass("is-playing")
                }
                ...
                function Y(d) {
                    ...
                    if ("feed_to_feeder" == g.call_from && 0 == b.hasClass("dzsap-loaded") && (Ea(), d = 300, is_ios(), is_android_good() && (d = 0), "with delay" != g.call_from_aux)) return d ? setTimeout(function () {
                        g.call_from_aux = "with delay";
                        Y(g)
                    }, d) : Y(g), !1;
                    for (Na = 0; Na < dzsap_list.length; Na++) dzsap_list[Na].get(0) &&
                    dzsap_list[Na].get(0).api_pause_media && dzsap_list[Na].get(0) != b.get(0) && (dzsap_list[Na].data("type_audio_stop_buffer_on_unfocus") && "on" == dzsap_list[Na].data("type_audio_stop_buffer_on_unfocus") ? dzsap_list[Na].get(0).api_destroy_for_rebuffer() : dzsap_list[Na].get(0).api_pause_media({audioapi_setlasttime: !1}));
                    ...
                    "on" == a.google_analytics_send_play_event && window.ga && 0 == Bc && (window.console && console.log("sent event"), Bc = !0, window.ga("send", {
                        hitType: "event",
                ...
                var Hd = "ap1", Id = "", Na = 0, pa, G = 0, K = 0, O, ca = null, Aa = null, E = null, Ka, P = null,
                    Rb = null, J, w, Za, Mc, $a, T, m = null, la = null, Ra = null, id, A, ea = null, Ca = null,
                    C = null, X = null, I = null, N = null, q = null, ya = null, ta = !1, zb = !1, ab = !1, Ic = !1,
                    Hb = !1, Bc = !1, Uc = !1, vc = !1, ec = !1, wb = !1, yd = !1, bd = !1, nd = !1, Qc = !1, od = !1,
                    B = 0, wd = 0, ha = -1, Wa = -1, U = -1, pb = -1, H = 0, gd = 0, Dc = 0, aa = 0, eb = 0, Z = 0,
                    Xa = 0, ma =
                        0, Cc = 0, ic = 0, dc = 0, ld = 0, Tc = 0, Kd = 0, Fd = -1, fa = 0, Gb = 1, Dd = 1, D = "", za = "",
                    Vb, ac = 0, qd = 0, Fa, xa = "", bb = "", Kc = "", zd = !1, $c = !1, dd = !1, cd = !1, yc = !1,
                    cb = !1, Ob = !0, hd = !1, Qb = !1, yb = !1, rb = !1, Nc = !1, vd = !1, kb = !1, ja = null, Ma = 0,
                    fd = !1, Jd = 0, Ab = 0, Wb = null, F = null, ra = null, M = [], wc = null, ob = !1, nb = !1,
                    pd = null, mb = null, L = "normal", Ya = "", tc = null, Zc = 100, Yb = 100, y = "", qb = 0,
                    mc = null, qc = "", lb = 0, ia = "auto", Ua = 0, cc = "audio", Mb = "", Jc = 0, Va = 0, jd = 0,
                    Ga = -1, V = "off", Vc = !1, xb = 1, kd = "127.0.0.1", xc = null, Ac = null, ed = null, zc = null,
                    Oc = null, Ib = !0, Zb = "auto", sd = "", na = "", va =
                        "", Tb = "", ud = 20, ad = 0, td = 0, bc = 0, Pc = null;
                ...
                (function () {
                    ...
                    if (!b.hasClass("audioplayer")) {
                        ...
                        "skin-wave" != a.design_skin || "audio" != y && "soundcloud" != y && "fake" != y || "on" != a.skinwave_comments_enable || (d = '<div class="comments-holder">', d = a.skinwave_comments_links_to ? d + ('<a href="' + a.skinwave_comments_links_to + '" target="_blank" class="the-bg"></a>') : d + '<div class="the-comments-holder-bg"></div>', d += '</div><div class="clear"></div><div class="comments-writer"><div class="comments-writer-inner"><div class="setting"><div class="setting-label"></div><textarea name="comment-text" placeholder="Your comment.." type="text" class="comment-input"></textarea><div class="float-right"><button class="submit-ap-comment dzs-button-dzsap float-right">Submit</button><button class="cancel-ap-comment dzs-button-dzsap float-right">Cancel</button></div><div class="overflow-it"><input placeholder="Your email.." name="comment-email" type="text" class="comment-input"/></div><div class="clear"></div></div></div></div>',
                            "normal" == L ? ca.appendOnce(d) : b.appendOnce(d), C = b.find(".comments-holder").eq(0), X = b.find(".comments-writer").eq(0), Ba({call_from: "default"}), C.on("click", Gc), X.find(".cancel-ap-comment").bind("click", lc), X.find(".submit-ap-comment").bind("click", Lb));
                        ...
                        a.cue && (Ua = 1);
                        "youtube" == y && is_ios();
                        if ("on" == a.cue && "soundcloud" != y) if ((is_android() || is_ios()) && b.find(".playbtn").bind("click", Y), Ya = b.attr("data-source"), -1 < Ya.indexOf("{{generatenonce}}")) {
                            var g = "";
                            (d = /id=(\d*?)/g.exec(Ya)) && (g = d[1]);
                            c.ajax({
                                type: "POST", url: Ya, data: {}, success: function (a) {
                                    a && -1 < a.indexOf(g) && (b.attr("data-source", a), Da())
                                }
                            })
                        } else "icecast" != na ? (Da(), "shoutcast" == na && setInterval(function () {
                            k()
                        }, 1E4)) : "icecast" == na && setInterval(function () {
                            k()
                        }, 1E4); else b.find(".playbtn").bind("click",
        ...
        c.fn.audiogallery = function (a) {
            ...
            this.each(function () {
                ...
                function f(a, e) {
                    ...
                    x.hasClass("isotoped") ? x.isotope({filter: f}) : x.children().each(function () {
                ...
                function r() {
                    if (t.attr("data-track-data")) {
                        ...
                        wa && wa.length && (Q.find(".menu-item-views").each(function () {
                            var e = c(this), f = e.html(), k = /{{views_(.*?)}}/g.exec(f);
                            if (k && k[1]) {
                                var l = k[1];
                                for (var n in wa) if (l == wa[n].label || l == "ap" + wa[n].label) {
                            ...
                            var a = c(this), e = a.html(), f = /{{views_(.*?)}}/g.exec(e);
                ...
                function v() {
                    ...
                    for (S = 0; S < qa.length; S++) a = "", qa[S].menu_description && -1 == qa[S].menu_description.indexOf('<div class="menu-item-thumb-con"><div class="menu-item-thumb" style="') &&
                ...
                function kc(e, f, k) {
                    ...
                    (a.settings_php_handler || cthis.hasClass("is-preview")) && c.ajax({
                        type: "POST",
                        url: a.settings_php_handler, data: e, success: function (a) {
                ...
                function Lb(e) {
                    ...
                    Ta <= Ba || (Ba = Q.outerHeight(), e = e / Ba * -(Ta - Ba + 50) + 20, 0 < e && (e = 0), e < -(Ta - Ba + 10) && (e = -(Ta - Ba + 10)), Kb = e, 0 == is_ios() && 0 == is_android() && "on" != a.enable_easing && R.css({transform: "translateY(" + Kb + "px)"}))
                }

                function Jb(a) {
                    var e = c(this);
                    if ("click" == a.type && (e.hasClass("menu-item") && (a = e.parent().children().index(e), ua(a)), e.hasClass("menu-btn-like") || e.hasClass("menu-facebook-share"))) return e.parent().parent().attr("data-playerid") &&
                    kc(1, e.parent().parent().attr("data-playerid"), {refferer: e}), !1
                }
                ...
                function ua(e, f) {
                    ...
                    f && (k = c.extend(k, f));
                    if (1 != Ia) if ("last" == e && (e = x.children().length - 1), z == e) x && x.children().eq(z).get(0) && x.children().eq(z).get(0).api_play_media && x.children().eq(z).get(0).api_play_media({call_from: "gallery"}); else {
                        ...
                        "fade" == a.transition && (x.children().eq(z).animate({}, {queue: !1}), setTimeout(Nb, 300), Ia = !0), "direct" == a.transition && Nb()));
                        ...
                        if ("one" == a.mode_normal_video_mode && 0 < e) {
                            ...
                            n && n.api_play_media && (n.api_change_media(x.children().eq(e), {call_from: "goto_item -- mode_normal_video_mode()"}), "on" == a.autoplayNext && setTimeout(function () {
                                n.api_play_media()
                            }, 200))
                        } else Pb(da, l), "on" == a.autoplayNext && ("mode-showall" == a.settings_mode && (z = t.get(0).currNr_2), -1 < z && da.get(0) && da.get(0).api_play &&
                        da.get(0).api_play());
                        dzsap_currplayer_focused = da.get(0);
                        "mode-showall" != a.settings_mode && ("fade" == a.transition && (da.css({}), da.animate({}, {queue: !1})), da.addClass("transitioning-in"), "link" != da.attr("data-type") && 0 == k.ignore_linking && "on" == a.settings_enable_linking && history.pushState({foo: "bar"}, null, add_query_arg(window.location.href, "audiogallery_startitem_" + ka, e)));
                        ...
                        k && t.parent().hasClass("ap-wrapper") && 0 < t.parent().children(".the-bg").length && (t.parent().children(".the-bg").eq(0).after('<div class="the-bg" style="background-image: url(' + k + ');"></div>'), t.parent().children(".the-bg").eq(0).css({opacity: 1}), t.parent().children(".the-bg").eq(1).css({opacity: 0}), t.parent().children(".the-bg").eq(1).animate({opacity: 1}, {
                            queue: !1, duration: 1E3, complete: Hc, step: function () {
                                Ia =
                                    !0
                            }
                        }), Ia = !0);
                ...
                Ia =
                    !1;
                var Ha = !0, nc = !0, pc = !1, oc = !1, qa = [], wa = [],
                    ib = "You need to comment or rate before downloading.", jb = 0, Ub = 0, Kb = 0, Da = 0;
                ...
                t.get(0).currNr_2 = -1;
                (function () {
                    if (t.attr("data-player-options")) try {
                    ...
                    if (typeof t.attr("id")) ka = t.attr("id"); else {
                    ...
                    "mode-showall" == a.settings_mode && (x.children().each(function () {
                        var e = c(this), f = e.parent().children(".audioplayer,.audioplayer-tobe").index(e);
    ...
    jQuery(document).ready(function (c) {
        ...
        c(document).on("click.dzsap_metas", ".audioplayer-song-changer, .dzsap-wishlist-but",
            function () {
                ...
                if (a.hasClass("dzsap-wishlist-but")) return e = {
                    action: "dzsap_add_to_wishlist",
                    playerid: a.attr("data-post_id"),
                    wishlist_action: "add"
                }, a.find(".svg-icon").hasClass("fa-star") && (e.wishlist_action = "remove"), window.dzsap_lasto.settings_php_handler && c.ajax({
                    type: "POST",
                    url: window.dzsap_lasto.settings_php_handler, data: e, success: function (c) {
        ...
        c(document).on("keydown.dzsapkeyup keypress.dzsapkeyup", function (a) {
            ...
            if (dzsap_currplayer_focused && dzsap_currplayer_focused.api_pause_media) {
                ...
                if (f && 0 == c(dzsap_currplayer_focused).hasClass("comments-writer-active") &&
                    (c(dzsap_currplayer_focused).hasClass("is-playing") ? dzsap_currplayer_focused.api_pause_media() : dzsap_currplayer_focused.api_play_media(), window.dzsap_mouseover)) return a.preventDefault(), !1;
                f = !1;
        ...
        c(document).on("click", ".dzsap-like-but", function (a) {
            var e = c(this), f = e.attr("data-post_id");
...
var MD5 = function (c) {
    function f(a, c) {
        var e = a & 2147483648, f = c & 2147483648, k = a & 1073741824, l = c & 1073741824;
    ...
    k = function (a) {
        for (var c = a.length, e = c + 8, f = 16 * ((e - e % 64) / 64 + 1), k = Array(f -
            1), l, n = 0; n < c;) e = (n - n % 4) / 4, l = n % 4 * 8, k[e] |= a.charCodeAt(n) << l, n++;
        k[(n - n % 4) / 4] |= 128 << n % 4 * 8;
        k[f - 2] = c << 3;
        k[f - 1] = c >>> 29;
        return k
    }(c);
    var u = 1732584193, n = 4023233417, r = 2562383102, l = 271733878;
    for (c = 0; c < k.length; c += 16) {
        var Bb = u, fb = n, Cb = r, Db = l;
...
window.dzsap_wp_send_contor_60_secs = function (c, f) {
    ...
    jQuery.ajax({
        type: "POST", url: f, data: c, success: function (c) {
        }, error: function (c) {
        }
    })
};
...
if (window.jQuery) register_dzsap_plugin(), register_dzsap_aux_script(), jQuery(document).ready(function (c) {
...
window.dzsap_init_multisharer = function () {
    ...
    setTimeout(function () {
        if (!window.dzsap_multisharer_assets_loaded && 1 != window.dzsap_multisharer_assets_loaded && 1 != window.loading_multi_sharer) {
            ...
            var f = document.getElementsByTagName("head")[0], v = document.createElement("link");
